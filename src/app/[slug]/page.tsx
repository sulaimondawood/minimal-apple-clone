...
export default async function Detail({ params }: any) {
  ...
  return (
    <section
      style={{ backgroundColor: res.backgroundColor }}
        ...
        <div className={styles.grid_2}>
          ...
          <div className={styles.grid_item_right}>
            ...
            >
              ...
              <img
                className={styles.option_img}
                src={urlForImage(res?.sec2gridone[3])?.url() && ""}
                alt=""
              />
            </div>
          </div>
          ...
          <article className={styles.sub_wrp}>
            ...
            <div className={styles.bottom}>
              <article className={styles.col_1}>
                <div>
                  <img src={urlForImage(res.sec4GridItem1Image).url()} alt="" />
                  <h2>{res.sec4GridItem1Name}</h2>
                  <p>{res.sec4GridItem1Text}</p>
                  <p>{res.sec4GridItem1Price}</p>
                ...
                <div>
                  <img src={urlForImage(res.sec4GridItem2Image).url()} alt="" />
                  <h2>{res.sec4GridItem2Name}</h2>
                  <p>{res.sec4GridItem2Text}</p>
                  <p>{res.sec4GridItem2Price}</p>
                  <Link className={styles.buy_link} href={""}>
                    Buy
                  </Link>
                  <Link className={styles.l_link} href={""}>
                ...
                <div>
                  <img src={urlForImage(res.sec4GridItem3Image).url()} alt="" />
                  <h2>{res.sec4GridItem3Name}</h2>
                  <p>{res.sec4GridItem3Text}</p>
                  <p>{res.sec4GridItem3Price}</p>
                  <Link className={styles.buy_link} href={""}>
                    Buy
                  </Link>
                  <Link className={styles.l_link} href={""}>
                ...
                <div>
                  <img src={urlForImage(res.sec4GridItem4Image).url()} alt="" />
                  <h2>{res.sec4GridItem4Name}</h2>
                  <p>{res.sec4GridItem4Text}</p>
                  <p>{res.sec4GridItem4Price}</p>
                  <Link className={styles.buy_link} href={""}>
                    Buy
                  </Link>
                  <Link className={styles.l_link} href={""}>
